...
>
> - No se detenga esperando datos.
> - Reaccione solo cuando es necesario.
> - Siga ejecutando otras tareas.
...
```{.py code-line-numbers="false" code-line-numbers="6" filename="coidgo.py" style="font-size:80%"}
def main(args=None):
  # 1. Inicialización
  rclpy.init(args=args)
...
## [Laboratorio (parte 2)](http://localhost:4200/clases/04/lab.html) {.center}
